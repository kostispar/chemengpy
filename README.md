...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Run `python chemeng.py si <physical-quantity>` in order to see the basic SI unit as well as the symbol and its definition of any physical quantity. For example you may run `python chemeng.py si energy`. This will print `joule, J, kg * (m^2) * (s^(-2))`
